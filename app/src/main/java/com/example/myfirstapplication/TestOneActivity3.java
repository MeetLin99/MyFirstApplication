...
public class TestOneActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LabelInit3.Init(TestOneActivity3.this, mLayout, labelLength, labelNum, labelIntervalLength);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        lastDownY = y;
                        mFrameLayout.addView(new TouchArea(TestOneActivity3.this, event.getX(), event.getY(), windowHeight / 2.0f));
                        break;
                    }
    ...
    protected void onDestroy() {
        ...
        ResDump.dump(TestOneActivity3.this, 1);
        super.onDestroy();
    }
}