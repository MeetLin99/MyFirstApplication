...
public class TestOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LabelInit.Init(TestOneActivity.this, mLayout, labelLength, labelNum, labelIntervalLength);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        lastDownY = y;
                        mFrameLayout.addView(new TouchArea(TestOneActivity.this, event.getX(), event.getY(), windowHeight / 2.0f));
                        break;
                    }
    ...
    protected void onDestroy() {
        ...
        ResDump.dump(TestOneActivity.this, 1);
        super.onDestroy();
    }
}